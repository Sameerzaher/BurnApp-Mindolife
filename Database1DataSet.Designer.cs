...
namespace WindowsFormsApplication1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class tbluserDataTable : global::System.Data.TypedTableBase<tbluserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public tbluserRow AddtbluserRow(string user, string pass, string role) {
        ...
        public partial class tbluserRow : global::System.Data.DataRow {
            ...
            public string user {
                get {
                    try {
                        return ((string)(this[this.tabletbluser.userColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'user\' in table \'tbluser\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tabletbluser.userColumn] = value;
                }
            }
            ...
            public bool IsuserNull() {
                return this.IsNull(this.tabletbluser.userColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetuserNull() {
                this[this.tabletbluser.userColumn] = global::System.Convert.DBNull;
            }
...
namespace WindowsFormsApplication1.Database1DataSetTableAdapters {
    ...
    public partial class tbluserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `tbluser` WHERE ((`ID` = ?) AND ((? = 1 AND `user` IS NULL) OR (`user" +
                "` = ?)) AND ((? = 1 AND `pass` IS NULL) OR (`pass` = ?)) AND ((? = 1 AND `role` " +
                "IS NULL) OR (`role` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `tbluser` (`user`, `pass`, `role`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `tbluser` SET `user` = ?, `pass` = ?, `role` = ? WHERE ((`ID` = ?) AND ((?" +
                " = 1 AND `user` IS NULL) OR (`user` = ?)) AND ((? = 1 AND `pass` IS NULL) OR (`p" +
                "ass` = ?)) AND ((? = 1 AND `role` IS NULL) OR (`role` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, [user], pass, role FROM tbluser";
        ...
        public virtual int Fill(Database1DataSet.tbluserDataTable dataTable) {
        ...
        public virtual Database1DataSet.tbluserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.tbluserDataTable dataTable = new Database1DataSet.tbluserDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.tbluserDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_user, string Original_pass, string Original_role) {
        ...
        public virtual int Update(string user, string pass, string role, int Original_ID, string Original_user, string Original_pass, string Original_role) {
            if ((user == null)) {
